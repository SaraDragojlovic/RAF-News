<template>
    <div class="search-page">
      ...
      <div class="search-container">
        <NewsCard v-for="news in searchNews" :key="news.id" :news="news" :showCategory="true" />
      </div>
  ...
  export default {
    ...
    methods: {
      async fetchNews(page) {
        ...
        const response = await this.$axios.get(`http://localhost:8080/api/news/search/${query}/${page}`, {
          headers: {
        ...
        this.searchNews = response.data.slice(0, 10);
